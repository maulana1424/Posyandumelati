...
$cam = query("SELECT*FROM daftar_balita");
    ...
    <div class="col-md-10 pr-5 pt-5">
      ...
      <div class="form-container">
        <form action="" method="POST">
          <input type="text" id="keyword" size="40" name="keyword" placeholder="masukan keyword" autocomplete="off">
          <button type="submit" class="btn btn-primary" name="cari">Cari</button><br>
            ...
            foreach ($cam as $cmb) : ?>
              <tr>
                ...
                <td class="list-group-item">
                  <a href="detail_balita.php?id_balita=<?= $cmb['id_balita']; ?>" class="btn btn-warning" role="button"><i class="fa-solid fa-id-badge"></i> Profil</a>
